...
<div class="wrap">
  ...
  <form name="limelight_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
    ...
    <p><?php _e("Video player width (px): " ); ?><input type="text" name="ll_org_id" value="<?php echo $ll_default_width; ?>" size="32"><?php _e(" ex: 480" ); ?></p>
    <p><?php _e("Video player height (px): " ); ?><input type="text" name="ll_org_id" value="<?php echo $ll_default_height; ?>" size="32"><?php _e(" ex: 411" ); ?></p>
